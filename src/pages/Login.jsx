    ...
    <main className="login-page">
      ...
      <section className="login-card" aria-labelledby="login-title">
        <header className="login-intro">
          ...
          <div>
            <p className="login-eyebrow">Grantha Exports</p>
            <h1 id="login-title">Welcome back</h1>
          </div>
        </header>
        <p className="login-description">
          Admins sign in with their registered email. Staff sign in with the
          Access ID created in Admin Settings.
        </p>
        <form onSubmit={submit}>
          <label>
            Staff Access ID or admin email
            <input
              value={accessId}
              onChange={(event) => {
                setError("");
              ...
              placeholder="e.g. EMP123 or admin@email.com"
              required
            />
          </label>
          <label>
